...
class TableChartDetailPane(_FeatureDetailPaneBase):
    ...
    def __init__(self, parent=None):
        ...
        caption_card = Card("题注与编号", parent=self)
        ...
        caption_card.add_widget(FormRow("题注样式", self._caption_style_combo, parent=caption_card))
        ...
        layout_card = Card("版式规则", parent=self)
        ...
        layout_card.add_widget(FormRow("图表居中", self._center_toggle, parent=layout_card))
        ...
        layout_card.add_widget(FormRow("续表延续题注", self._continued_toggle, parent=layout_card))
...
class PageElementsDetailPane(_FeatureDetailPaneBase):
    ...
    def __init__(self, parent=None):
        ...
        header_card = Card("页眉页脚策略", parent=self)
        ...
        header_card.add_widget(FormRow("页眉页脚", self._header_footer_combo, parent=header_card))
        ...
        header_card.add_widget(FormRow("页码联动", self._page_number_toggle, parent=header_card))
        self._layout.addWidget(header_card)

        toc_card = Card("目录与附加项", parent=self)
        ...
        toc_card.add_widget(FormRow("自动刷新目录", self._toc_toggle, parent=toc_card))
        ...
        toc_card.add_widget(
            FormRow("目录深度", self._toc_depth_slider, suffix_widget=self._toc_depth_value, parent=toc_card)
        )
...
class FormulaDetailPane(_FeatureDetailPaneBase):
    ...
    def __init__(self, parent=None):
        ...
        formula_card = Card("公式样式", parent=self)
        ...
        formula_card.add_widget(FormRow("公式样式", self._formula_style_combo, parent=formula_card))
        ...
        formula_card.add_widget(FormRow("显示方式", self._formula_align_combo, parent=formula_card))
        self._layout.addWidget(formula_card)

        chemistry_card = Card("化学式与间距", parent=self)
        ...
        chemistry_card.add_widget(FormRow("启用化学式修正", self._chem_toggle, parent=chemistry_card))
...
class CitationDetailPane(_FeatureDetailPaneBase):
    ...
    def __init__(self, parent=None):
        ...
        citation_card = Card("引文规范", parent=self)
        ...
        citation_card.add_widget(FormRow("引文样式", self._citation_style_combo, parent=citation_card))
        ...
        citation_card.add_widget(FormRow("正文上标联动", self._superscript_toggle, parent=citation_card))
        self._layout.addWidget(citation_card)

        numbering_card = Card("编号与去重", parent=self)
        ...
        numbering_card.add_widget(FormRow("自动重排编号", self._renumber_toggle, parent=numbering_card))
        ...
        numbering_card.add_widget(
            FormRow("去重阈值", self._dedupe_slider, suffix_widget=self._dedupe_value, parent=numbering_card)
        )
...
class CleanupDetailPane(_FeatureDetailPaneBase):
    ...
    def __init__(self, parent=None):
        ...
        rule_card = Card("清理规则", parent=self)
        ...
        rule_card.add_widget(FormRow("Markdown / LaTeX 残留清理", self._markdown_toggle, parent=rule_card))
        ...
        rule_card.add_widget(FormRow("空白与换行规范化", self._whitespace_toggle, parent=rule_card))
        self._layout.addWidget(rule_card)

        audit_card = Card("质量闸门", parent=self)
        ...
        audit_card.add_widget(FormRow("执行前结构校验", self._audit_toggle, parent=audit_card))
        ...
        audit_card.add_widget(
            FormRow("校验强度", self._strictness_slider, suffix_widget=self._strictness_value, parent=audit_card)
        )
