...
CONTROL_CONTRACTS: tuple[ControlContract, ...] = (
    ...
    _contract(
        ...
        (
            "scene.thesis_formula_rules.formula_enabled",
            "scene.thesis_formula_rules.formula_convert.enabled",
            "scene.thesis_formula_rules.formula_convert.output_mode",
            "scene.thesis_formula_rules.formula_convert.low_confidence_policy",
            "scene.thesis_formula_rules.formula_convert.office_fallback_enabled",
            "scene.thesis_formula_rules.formula_to_table.enabled",
            "scene.thesis_formula_rules.formula_to_table.block_only",
            "scene.thesis_formula_rules.formula_table.formula_font_name",
            "scene.thesis_formula_rules.formula_table.formula_font_size_pt",
            "scene.thesis_formula_rules.formula_style.unify_font",
            "scene.thesis_formula_rules.formula_style.enabled",
            "scene.thesis_formula_rules.formula_style.unify_size",
            "scene.thesis_formula_rules.formula_style.unify_spacing",
            "scene.thesis_formula_rules.equation_numbering.numbering_format",
            "scene.thesis_formula_rules.equation_numbering.enabled",
            "scene.thesis_formula_rules.chem_typography.enabled",
            "scene.thesis_formula_rules.chem_typography.scopes",
        ),
        unit_set=("word_native", "latex", "keep_source", "skip_and_mark", "manual_review"),
        disabled_state_rule=(
            "full LaTeX projects and professional conversion quality remain plugin/manual gated"
        ),
        template_surface="none; templates do not persist or preview formula policy",
        scene_surface="thesis plan formula rules",
        ...
        evidence=(
            _evidence(
                ...
                "formula_table.formula_font_name",
            ),
            _evidence(
        ...
        notes=(
            "The thesis plan exclusively owns conversion, formula-table layout, "
            "numbering, style normalization, and script recovery."
        ),
    ),
    _contract(
        ...
        "水印状态",
        "scene",
        "scene policy + document watermark module",
        (
        ...
        disabled_state_rule="enabled=false preserves configured text while the runtime module skips insertion",
        template_surface="watermark visual baseline belongs to template/control contract",
        scene_surface="scene family policy owns document watermark status/text",
        ...
        evidence=(
            ...
            _evidence(
                ...
                "_inject_text_watermark",
            ),
        ),
        notes="Scene owns document watermark policy; material-image watermark policy is separately package-owned.",
    ),
    _contract(
        "material.schema_selection",
        "资料契约",
        "material",
        "MaterialPackage selector + canonical MaterialContract",
        (
            "material_package.material_contract_id",
            "material_package.metadata.material_contract_extensions",
            "material_run_selection.package_ref",
        ),
        disabled_state_rule="unknown schema or cross-mode contracts fail closed before preview and execution binding",
        scene_surface="scene no longer persists a material-profile/schema identity",
        workbench_surface="AssetsPanel package editor + Workbench package selector/repair target",
        evidence=(
            _evidence(
                "src/domain/materials/model.py",
                "class MaterialPackage",
                "material_contract_id",
            ),
            _evidence(
                "src/application/materials/contracts.py",
                "def default_material_contract_id",
        ...
        notes="The package contract is the only material-schema authority used by preview and execution.",
    ),
    _contract(
