...
N2_175_SCENE_CONTROL_RUNTIME_SPECS: tuple[SceneControlRuntimeSpec, ...] = (
    ...
    _spec(
        ...
        "scene_policy",
        (
            "thesis plan owns the complete formula rule aggregate",
            "templates own no formula typography or numbering baseline",
            "full LaTeX/OCR/professional conversion remains plugin/manual gated",
        ),
        (
            "SceneWorkspace.thesis_formula_rules",
            "ThesisFormulaRules.formula_table",
            "Workbench formula confidence boundary",
        ),
        ("non-thesis plans fail closed",),
    ...
    _spec(
        ...
        (
            "SceneWatermarkRulesCard._watermark_enabled",
            "SceneWatermarkRulesCard._watermark_text",
        ),
        ...
        (
            _evidence(
                ...
                "src/ui/panels/scene_watermark_rules.py",
                "scene_ui",
                "_watermark_enabled",
                "_watermark_text",
                '"水印文本"',
    ...
    _spec(
        ...
        (
            "material contract is owned by the selected MaterialPackage",
            "unknown or cross-mode contracts fail closed",
            "scene projects requirements while AssetsPanel owns editing",
        ),
        (
            "SceneContentDetail canonical contract projection",
            "AssetsPanel MaterialPackage editor",
            "Workbench package selector",
            "MaterialPackage.material_contract_id",
        ),
        ("material package contract",),
        ("StyledComboBox", "QPushButton", "MaterialContract", "MaterialRunSelection"),
        (
        ...
        (
            _evidence(
                ...
                "editing remains exclusively in AssetsPanel",
                "default_material_contract_id",
                "current_material_run_selection",
            ),
            _evidence(
            ...
            _evidence(
                ...
                "get_package_material_contract(package)",
