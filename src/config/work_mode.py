...
_WORK_MODES: tuple[WorkModeSpec, ...] = (
    WorkModeSpec(
        ...
        material_schema_ids=("generic_document_v1",),
    ...
    WorkModeSpec(
        mode_id="engineering",
        label="工程文档版",
        description="工程界文档生成专家：可研/施组/专项方案/交底/合同/结算/概算等分阶段大纲与报告。",
        default_scene_id="engineering",
        default_template_id="eng_document",
        display_order=25,
        template_authoring_profile_id="template_authoring.engineering.v1",
        master_domain="engineering_master",
        master_family_ids=("engineering",),
        material_schema_ids=("engineering_document_v1",),
        aliases=("eng_doc", "工程文档", "工程"),
    ),
    WorkModeSpec(
        mode_id="thesis",
        label="论文版",
