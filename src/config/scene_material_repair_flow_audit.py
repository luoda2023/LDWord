...
N2_177_MATERIAL_REPAIR_FLOW_SPECS: tuple[SceneMaterialRepairFlowSpec, ...] = (
    _spec(
        ...
        "Material schema requirements projected to AssetsPanel controls",
        "all_material",
        ("material_schema_projection", "required_field_controls", "required_asset_controls"),
        ("material_schema_id", "material_schema_ids", "required_material_fields", "required_image_roles"),
        ("field", "asset"),
        (
            "build_material_requirements",
            "SceneSpecPresenterMixin._required_fields_from_scene",
        ...
        (
            _evidence(
                ...
                "ui",
                "def _required_fields_from_scene",
                "def _asset_slots_from_scene",
                "def _attachment_roles_from_scene",
                "build_material_requirements(",
            ),
            _evidence(
    ...
    _spec(
        ...
        ("missing_required_fields", "missing_asset_roles", "unmatched_placeholders"),
        ("field", "asset", "preview"),
    ...
    _spec(
        "material_issue_items_repair_targets",
        "Material WorkbenchIssueItem rows expose blocking repair targets",
        "all_material",
        ("issue_item_contract", "blocking_material_preflight", "repair_target_contract"),
        ("material.fields.missing", "material.assets.missing", "material.schema.unregistered"),
        ("field", "asset", "schema"),
        ("material_readiness_issue_items", "WorkbenchIssueItem"),
        ("QuickExecutionDetail issue queue",),
        (
            "test_material_readiness_issue_items_expose_schema_recommendation_for_workbench_queue",
            "test_material_readiness_issue_items_group_fields_and_assets_for_workbench_queue",
        ),
        (
            _evidence(
            ...
            _evidence(
                "test.workbench.material_issue_items",
                "tests/test_workbench_execution_center.py",
                "test",
    ...
    _spec(
        ...
        "Issue queue summarizes, filters, resolves, ignores, and emits repair actions",
        "all_material",
        ("issue_queue_actionability", "manual_repair_confirmation", "status_tracking"),
        ("actionable_count", "repair_target_counts", "visible_items", "status_counts"),
        ("field", "asset", "schema", "profile_field", "profile_asset", "profile_schema"),
        ("summarize_workbench_issue_queue", "workbench_issue_action_target"),
        (
            "QuickExecutionDetail issue filter",
            "QuickExecutionDetail issue action",
            "QuickExecutionDetail issue status buttons",
        ),
        (
        ...
        (
            _evidence(
                "runtime.workbench.issue_queue",
                "src/ui/adapters/workbench_execution_adapter.py",
                "runtime",
                "def summarize_workbench_issue_queue",
                "actionable_count",
                "repair_target_counts",
                "def workbench_issue_action_target",
            ),
            _evidence(
                "ui.quick_detail.issue_queue",
                "src/ui/panels/workbench/quick_execution_detail.py",
                "ui",
                "def _set_issue_queue_visible",
                "def _request_current_issue_action",
                "issue_repair_requested.emit",
                "def _mark_current_issue_resolved",
                "def _mark_current_issue_ignored",
            ),
            _evidence(
                "test.quick_detail.issue_queue",
    ...
    _spec(
        ...
        "QuickExecutionDetail exposes a direct material repair button",
        "all_material",
        ("quick_repair_entry", "material_gap_tooltip", "field_asset_priority"),
        ...
        ("QuickExecutionDetail material repair button",),
        (
    ...
    _spec(
        ...
        "Workbench routes material repair targets through PanelBridge",
        "all_material",
        ...
        ("field", "asset", "schema", "profile_field", "profile_asset", "profile_schema"),
        ("WorkbenchPanel._open_issue_repair_target", "PanelBridge.request_material_repair_target"),
        ("Assets panel navigation", "Scene content detail"),
        (
            "test_workbench_panel_routes_quick_asset_repair_to_assets_panel_target",
            "test_workbench_panel_routes_quick_field_repair_to_assets_panel_target",
    ...
    _spec(
        ...
        "Unknown schema ids get a recommended replacement and schema repair target",
        "schema_reference",
        ("schema_alias_recommendation", "unregistered_schema_blocker", "schema_repair_target"),
        ("missing_schema_ids", "recommendation_schema_id", "recommendation_reasons"),
        ("schema", "content_fill"),
        ("recommend_material_schema_replacement", "material_readiness_issue_groups"),
        ("QuickExecutionDetail repair tooltip", "Workbench issue queue"),
        (
            "test_material_readiness_issue_groups_recommend_schema_replacement",
            "test_material_readiness_issue_items_expose_schema_recommendation_for_workbench_queue",
            "test_quick_execution_detail_shows_schema_replacement_recommendation_in_repair_tooltip",
    ...
    _spec(
        ...
        "Batch material failures preserve profile-scoped field and asset repair targets",
        "batch_material",
        ...
        ("batch_execution_issue_items", "workbench_issue_action_target"),
        ("QuickExecutionDetail batch issue queue", "AssetsPanel profile selection"),
        (
            "test_execution_adapter_converts_batch_issue_payloads_to_workbench_issues",
            "test_quick_execution_detail_consumes_batch_issue_items_from_result_state",
        ),
        (
            _evidence(
...
def _source_evidence(
    ...
    evidence: list[SceneMaterialRepairFlowEvidence] = []
    for spec in specs:
