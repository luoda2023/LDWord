...
NATURAL_REQUEST_ROUTES: tuple[NaturalRequestRoute, ...] = (
    ...
    NaturalRequestRoute(
        route_id="engineering_document_authoring",
        label="Engineering document authoring by project stage",
        pack_id="engineering_materials",
        aliases=(
            "可行性研究报告",
            "可研报告",
            "可研",
        ...
        route_type="executable_scene",
        context_tokens=("工程", "施工", "项目", "概算", "结算", "招标", "投标", "合同"),
        anti_tokens=("论文", "公文", "试卷", "简历", "投标资质附件", "资质证照"),
        reason=(
            "Engineering document requests (feasibility, scheme, bid, contract, "
            "settlement, estimate) route to the engineering authoring expert so "
            "sections follow industry stage conventions."
        ),
        disambiguation_prompt="请确认该工程文档属于哪个阶段：决策立项/设计报批/招投标与合同/施工实施/竣工结算/造价分析。",
    ),
    NaturalRequestRoute(
