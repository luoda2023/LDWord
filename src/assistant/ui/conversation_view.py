...
class AssistantConversationMessage(QWidget):
    """Role-aware message row matching Alavette Design's reading geometry."""
    ...
    def __init__(
        ...
        *,
        ...
        self._column.setMaximumWidth(_MESSAGE_COLUMN_WIDTH)
    ...
    def _build_assistant_message(self, status_text: str) -> None:
        ...
        self._assistant_body.setMaximumWidth(_ASSISTANT_CONTENT_WIDTH)
