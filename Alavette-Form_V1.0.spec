...
a = Analysis(
    ...
    hiddenimports=['PySide6.QtCore', 'PySide6.QtGui', 'PySide6.QtWidgets', 'PySide6.QtSvg', 'shiboken6', 'latex2mathml', 'olefile', 'pythoncom', 'win32com.client', 'src.shared.io.mathtype_office_fallback', 'src.ui.panels.workbench', 'src.ui.panels.workbench.panel_v2', 'src.ui.panels.workbench.batch_generation_source_area', 'src.ui.panels.scene_panel', 'src.ui.panels.template_panel', 'src.ui.panels.theme_panel', 'src.ui.panels.assets_panel', 'src.assistant.ui.assistant_panel', 'src.ui.panels.preferences_panel', 'src.domain.materials', 'src.application.materials', 'src.infrastructure.materials.repository', 'src.material_suite.plan', 'src.material_suite.runner', 'src.shared.ui.button_style', 'src.shared.ui.dashed_separator', 'src.shared.ui.detail_pane_controller', 'src.shared.ui.dialogs', 'src.shared.ui.dynamic_navigation_rail', 'src.shared.ui.flow_layout', 'src.shared.ui.font_combo', 'src.shared.ui.input_style', 'src.shared.ui.library_action_row', 'src.shared.ui.master_detail_shell', 'src.shared.ui.navigation_card', 'src.shared.ui.preview_dialog', 'src.shared.ui.selection_control_style', 'src.shared.ui.styled_combo_box', 'src.shared.ui.summary_grid', 'src.shared.ui.template_summary_card', 'src.shared.ui.themed_radio_button', 'src.shared.ui.theme', 'src.shared.ui.toast'],
    hookspath=[],
    hooksconfig={},
