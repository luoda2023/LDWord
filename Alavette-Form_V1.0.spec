...
a = Analysis(
    ...
    pathex=[],
    binaries=[],
    datas=[('defaults', 'defaults'), ('build\\release_config_library', 'config_library'), ('count_profiles', 'count_profiles'), ('src\\shared\\ui\\icons\\app_logo.svg', 'src\\shared\\ui\\icons'), ('LICENSE', '.'), ('THIRD_PARTY_NOTICES.md', '.'), ('RELEASE_NOTES.md', '.'), ('SECURITY.md', '.'), ('licenses', 'licenses')],
